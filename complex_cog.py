...
class Music(commands.Cog):
    ...
    @commands.command(name='clear', aliases=['clr', 'c', 'bin'], description="clears entire queue")
    ...
    @commands.command(name='now', aliases=['song', 'current', 'currentsong', 'playing', 'np'], description="shows the current playing song")
    ...
    async def leave_(self, ctx):
        ...
        if (random.randint(0, 1) == 0):
            await ctx.message.add_reaction('👋')
        await ctx.send('Sayonara! **Disconnected**')
